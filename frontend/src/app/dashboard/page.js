...
function NodeCard({ node, t }) {
  ...
  return (
    <div style={{
      background: '#FFFFFF', border: `1.5px solid ${node.online ? color + '30' : '#FFBBBB'}`,
    ...
    <div style={{ background: '#F0F4FA', minHeight: '100vh' }}>
      <div className="container section">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12, marginBottom: 28 }}>
          ...
          <Link href="/dashboard/sync" style={{
        ...
        {loading ? (
          ...
          <>
            ...
            <Card style={{ marginBottom: 20 }}>
              ...
              <div style={{
                padding: '10px 14px', borderRadius: 8, background: '#F8FAFF', border: '1px solid #DDE3EE',
                ...
                {FLEET_MODELS.map(m => {
                  ...
                  return (
                    <div key={m.name} style={{
                      border: `1.5px solid ${m.color}30`, borderRadius: 12,
            ...
            <Card style={{ marginBottom: 20 }}>
              ...
              <div style={{ background: '#FFFFFF', border: '1px solid #DDE3EE', borderRadius: 10, padding: '16px' }}>
                <form onSubmit={(e) => {
                  ...
                  <input name="search" type="text" placeholder="Buscar pasajero por pasaporte" className="input" style={{ flex: 1 }} />
